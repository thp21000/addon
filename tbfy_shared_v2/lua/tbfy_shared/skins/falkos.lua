...
SKIN.PrintName		= "FalkOS"
SKIN.Author		= "Spar+ToBadForYou"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material("gwenskin/windows10.png")
...
SKIN.colPropertySheet			= Color(200, 200, 210, 255)
SKIN.colTab						= Color(0, 0, 0, 200)
SKIN.colTabInactive				= Color(50, 50, 50, 255)
...
function SKIN:PaintPropertySheet(panel, w, h)
	...
	local CToUse = SKIN.colPropertySheet
	if panel.OColor then
		CToUse = panel.OColor
	elseif ActiveTab.OColor then
		CToUse = ActiveTab.OColor
	end

	surface.SetDrawColor(CToUse)
	surface.DrawRect(1, 1 + Offset, w - 2, h - 2 - Offset)
end
...
derma.DefineSkin("FalkOS", "Based on Windows 10 UI", SKIN)
